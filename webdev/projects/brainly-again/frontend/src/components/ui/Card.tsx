...
const Card = ({ title, link, type }: cardProps) => {
    ...
    return (
        <div className="bg-white rounded-md shadow-md px-2 outline-slate-200  border border-slate-100">
            ...
            {
                type === "youtube" && <div className="mt-2">
                    <iframe className="w-full  rounded-md p-4" width="560" height="315"
                        src={link.replace("watch?v=", "embed/")} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" ></iframe>
                </div>
            }
