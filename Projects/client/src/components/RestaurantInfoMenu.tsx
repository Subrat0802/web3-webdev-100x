...
const RestaurantInfoMenu = ({ data } : {data:RestaurantInfoProps}) => {
  ...
  return (
    <div className="flex flex-col px-3 ">
      ...
      <div className="px-4">
        <div className="w-full flex flex-col gap-1 border border-gray-200 text-[#272727] rounded-2xl shadow-2xl mt-2  px-6 py-4 ">
          <div className="flex items-center text-lg dark:text-gray-400  font-bold ">
