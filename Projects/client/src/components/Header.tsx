...
const Header = () => {
  ...
  return (
    <div className="flex justify-center w-full  py-4 px-20 font-poppins dark:bg-[#0c0c0c] dark:text-white shadow-md">
      <div className="w-full flex justify-between ">
        <div className="flex justify-center items-center gap-10">
          ...
          <div className="flex text-sm group justify-center gap-2 cursor-pointer items-center ">
            <p className="underline group-hover:text-[#FF5200] transition-all  font-bold underline-offset-8 decoration-2">
              Other
            </p>
            <span className="font-semibold dark:text-gray-400 group-hover:text-gray-500 transition-all  text-gray-600">
              Gautam nagar Bhopal...
            </span>
        ...
        <div className="flex  justify-center items-center gap-10 text-md text-gray-700 ">
          <span className="cursor-pointer hover:text-[#FF5200] dark:text-gray-100 flex justify-center items-center gap-1">
            <FiHome /> Home
          </span>
          <span className="flex cursor-pointer hover:text-[#FF5200]  dark:text-gray-100 justify-center items-center gap-1">
            <FiSearch /> Search
          </span>
